...
const handler = async (client, args) => {
    ...
    return (0, types_1.asTextContentResult)(await client.onchain.networks.pools.ohlcv.getTimeframe(timeframe, body));
};
exports.handler = handler;
exports.default = { metadata: exports.metadata, tool: exports.tool, handler: exports.handler };
//# sourceMappingURL=get-timeframe-pools-networks-onchain-ohlcv.js.map