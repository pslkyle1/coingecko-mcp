...
const handler = async (client, args) => {
    ...
    return (0, types_1.asTextContentResult)(await client.onchain.networks.newPools.getNetwork(network, body));
};
exports.handler = handler;
exports.default = { metadata: exports.metadata, tool: exports.tool, handler: exports.handler };
//# sourceMappingURL=get-network-networks-onchain-new-pools.js.map