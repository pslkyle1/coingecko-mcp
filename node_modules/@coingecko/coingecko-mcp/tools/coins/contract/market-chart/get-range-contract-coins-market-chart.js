...
const handler = async (client, args) => {
    ...
    return (0, types_1.asTextContentResult)(await client.coins.contract.marketChart.getRange(contract_address, body));
};
exports.handler = handler;
exports.default = { metadata: exports.metadata, tool: exports.tool, handler: exports.handler };
//# sourceMappingURL=get-range-contract-coins-market-chart.js.map