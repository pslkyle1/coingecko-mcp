...
import { AssetPlatforms, } from "./resources/asset-platforms.mjs";
import { ExchangeRates } from "./resources/exchange-rates.mjs";
import { Key } from "./resources/key.mjs";
import { Ping } from "./resources/ping.mjs";
import { TokenLists } from "./resources/token-lists.mjs";
import { Coins } from "./resources/coins/coins.mjs";
import { Companies } from "./resources/companies/companies.mjs";
import { Derivatives } from "./resources/derivatives/derivatives.mjs";
import { Exchanges, } from "./resources/exchanges/exchanges.mjs";
import { Global } from "./resources/global/global.mjs";
import { NFTs, } from "./resources/nfts/nfts.mjs";
import { Onchain } from "./resources/onchain/onchain.mjs";
import { Search } from "./resources/search/search.mjs";
...
export class Coingecko {
     ...
     */
    constructor({ baseURL = readEnv('COINGECKO_BASE_URL'), proAPIKey = readEnv('COINGECKO_PRO_API_KEY') ?? null, demoAPIKey = readEnv('COINGECKO_DEMO_API_KEY') ?? null, ...opts } = {}) {
        ...
        __classPrivateFieldSet(this, _Coingecko_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!__classPrivateFieldGet(this, _Coingecko_instances, "m", _Coingecko_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return __classPrivateFieldGet(this, _Coingecko_encoder, "f").call(this, { body, headers });
        }
    }
}
