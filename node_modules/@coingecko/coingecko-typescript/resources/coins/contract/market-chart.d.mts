...
export declare class MarketChart extends APIResource {
    /**
     ...
     * ```
     */
    get(contractAddress: string, params: MarketChartGetParams, options?: RequestOptions): APIPromise<MarketChartGetResponse>;
    /**
     ...
     * ```
     */
    getRange(contractAddress: string, params: MarketChartGetRangeParams, options?: RequestOptions): APIPromise<MarketChartGetRangeResponse>;
}
...
export declare namespace MarketChart {
    export { type MarketChartGetResponse as MarketChartGetResponse, type MarketChartGetRangeResponse as MarketChartGetRangeResponse, type MarketChartGetParams as MarketChartGetParams, type MarketChartGetRangeParams as MarketChartGetRangeParams, };
}
//# sourceMappingURL=market-chart.d.mts.map