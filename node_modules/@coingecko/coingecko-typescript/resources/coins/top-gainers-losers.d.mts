...
export declare class TopGainersLosers extends APIResource {
    /**
...
export declare namespace TopGainersLoserGetResponse {
    interface TopGainersLoserGetResponseItem {
        /**
         * coin ID
         */
        id?: string;
...
export declare namespace TopGainersLosers {
    export { type TopGainersLoserGetResponse as TopGainersLoserGetResponse, type TopGainersLoserGetParams as TopGainersLoserGetParams, };
}
//# sourceMappingURL=top-gainers-losers.d.mts.map