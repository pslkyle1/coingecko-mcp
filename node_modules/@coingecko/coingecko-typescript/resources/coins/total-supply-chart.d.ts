...
export declare class TotalSupplyChart extends APIResource {
    /**
     ...
     * ```
     */
    get(id: string, query: TotalSupplyChartGetParams, options?: RequestOptions): APIPromise<TotalSupplyChartGetResponse>;
    /**
     ...
     * ```
     */
    getRange(id: string, query: TotalSupplyChartGetRangeParams, options?: RequestOptions): APIPromise<TotalSupplyChartGetRangeResponse>;
}
...
export declare namespace TotalSupplyChart {
    export { type TotalSupplyChartGetResponse as TotalSupplyChartGetResponse, type TotalSupplyChartGetRangeResponse as TotalSupplyChartGetRangeResponse, type TotalSupplyChartGetParams as TotalSupplyChartGetParams, type TotalSupplyChartGetRangeParams as TotalSupplyChartGetRangeParams, };
}
//# sourceMappingURL=total-supply-chart.d.ts.map