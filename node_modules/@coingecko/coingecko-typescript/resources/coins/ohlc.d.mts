...
export declare class Ohlc extends APIResource {
    /**
     ...
     * ```
     */
    getRange(id: string, query: OhlcGetRangeParams, options?: RequestOptions): APIPromise<OhlcGetRangeResponse>;
}
...
export declare namespace Ohlc {
    export { type OhlcGetResponse as OhlcGetResponse, type OhlcGetRangeResponse as OhlcGetRangeResponse, type OhlcGetParams as OhlcGetParams, type OhlcGetRangeParams as OhlcGetRangeParams, };
}
//# sourceMappingURL=ohlc.d.mts.map