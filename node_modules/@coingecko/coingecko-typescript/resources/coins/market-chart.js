...
class MarketChart extends resource_1.APIResource {
    /**
    ...
    get(id, query, options) {
        return this._client.get((0, path_1.path) `/coins/${id}/market_chart`, { query, ...options });
    }
    /**
     ...
     * ```
     */
    getRange(id, query, options) {
        return this._client.get((0, path_1.path) `/coins/${id}/market_chart/range`, { query, ...options });
    }
}
exports.MarketChart = MarketChart;
//# sourceMappingURL=market-chart.js.map