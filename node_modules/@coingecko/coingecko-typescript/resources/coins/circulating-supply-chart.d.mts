...
export declare class CirculatingSupplyChart extends APIResource {
    /**
     ...
     * ```
     */
    get(id: string, query: CirculatingSupplyChartGetParams, options?: RequestOptions): APIPromise<CirculatingSupplyChartGetResponse>;
    /**
     ...
     * ```
     */
    getRange(id: string, query: CirculatingSupplyChartGetRangeParams, options?: RequestOptions): APIPromise<CirculatingSupplyChartGetRangeResponse>;
}
