...
export declare class TokenPrice extends APIResource {
    /**
     ...
     * ```
     */
    getID(id: string, query: TokenPriceGetIDParams, options?: RequestOptions): APIPromise<TokenPriceGetIDResponse>;
}
...
export declare namespace TokenPrice {
    export { type TokenPriceGetIDResponse as TokenPriceGetIDResponse, type TokenPriceGetIDParams as TokenPriceGetIDParams, };
}
