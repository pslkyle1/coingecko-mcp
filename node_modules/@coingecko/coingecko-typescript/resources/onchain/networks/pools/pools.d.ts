...
export declare class Pools extends APIResource {
     ...
     * ```
     */
    get(network: string, query?: PoolGetParams | null | undefined, options?: RequestOptions): APIPromise<PoolGetResponse>;
    /**
...
export declare namespace PoolGetAddressResponse {
    interface Data {
        id?: string;
        attributes?: Data.Attributes;
        relationships?: Data.Relationships;
...
export declare namespace Pools {
    export { type PoolGetResponse as PoolGetResponse, type PoolGetAddressResponse as PoolGetAddressResponse, type PoolGetParams as PoolGetParams, type PoolGetAddressParams as PoolGetAddressParams, };
