...
export declare class Dexes extends APIResource {
    /**
     ...
     * ```
     */
    get(network: string, query?: DexGetParams | null | undefined, options?: RequestOptions): APIPromise<DexGetResponse>;
    /**
...
export declare namespace DexGetResponse {
    interface Data {
        id?: string;
...
export declare namespace DexGetPoolsResponse {
    interface Data {
        id?: string;
        attributes?: Data.Attributes;
...
export declare namespace Dexes {
    export { type DexGetResponse as DexGetResponse, type DexGetPoolsResponse as DexGetPoolsResponse, type DexGetParams as DexGetParams, type DexGetPoolsParams as DexGetPoolsParams, };
}
//# sourceMappingURL=dexes.d.mts.map