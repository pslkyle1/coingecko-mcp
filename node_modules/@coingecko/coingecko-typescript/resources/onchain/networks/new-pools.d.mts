...
export declare class NewPools extends APIResource {
    /**
     ...
     * ```
     */
    get(query?: NewPoolGetParams | null | undefined, options?: RequestOptions): APIPromise<NewPoolGetResponse>;
    /**
     ...
     * ```
     */
    getNetwork(network: string, query?: NewPoolGetNetworkParams | null | undefined, options?: RequestOptions): APIPromise<NewPoolGetNetworkResponse>;
}
export interface NewPoolGetResponse {
    data?: Array<NewPoolGetResponse.Data>;
    included?: Array<NewPoolGetResponse.Included>;
}
export declare namespace NewPoolGetResponse {
    interface Data {
        id?: string;
...
export declare namespace NewPoolGetNetworkResponse {
    interface Data {
        id?: string;
        attributes?: Data.Attributes;
        relationships?: Data.Relationships;
...
export declare namespace NewPools {
    export { type NewPoolGetResponse as NewPoolGetResponse, type NewPoolGetNetworkResponse as NewPoolGetNetworkResponse, type NewPoolGetParams as NewPoolGetParams, type NewPoolGetNetworkParams as NewPoolGetNetworkParams, };
}
//# sourceMappingURL=new-pools.d.mts.map