...
export declare class Trending extends APIResource {
    /**
     ...
     * ```
     */
    get(query?: TrendingGetParams | null | undefined, options?: RequestOptions): APIPromise<TrendingGetResponse>;
}
...
export declare namespace TrendingGetResponse {
    interface Category {
        id?: number;
        /**
...
//# sourceMappingURL=trending.d.mts.map