...
export declare class DecentralizedFinanceDefi extends APIResource {
    /**
...
export declare namespace DecentralizedFinanceDefiGetResponse {
    interface Data {
        /**
         * defi dominance
         */
...
//# sourceMappingURL=decentralized-finance-defi.d.ts.map