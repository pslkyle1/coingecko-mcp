...
export declare class MarketCapChart extends APIResource {
    /**
...
export declare namespace MarketCapChartGetResponse {
...
export declare namespace MarketCapChart {
    export { type MarketCapChartGetResponse as MarketCapChartGetResponse, type MarketCapChartGetParams as MarketCapChartGetParams, };
}
//# sourceMappingURL=market-cap-chart.d.ts.map