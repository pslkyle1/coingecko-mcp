...
import { MarketChart, MarketChartGetParams, MarketChartGetResponse } from "./market-chart.mjs";
import * as TickersAPI from "./tickers.mjs";
import { TickerGetResponse, Tickers } from "./tickers.mjs";
import * as ContractAPI from "./contract/contract.mjs";
import { Contract, ContractGetContractAddressParams, ContractGetContractAddressResponse } from "./contract/contract.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
export declare class NFTs extends APIResource {
     ...
     * ```
     */
    getList(query?: NFTGetListParams | null | undefined, options?: RequestOptions): APIPromise<NFTGetListResponse>;
    /**
     ...
     * ```
     */
    getMarkets(query?: NFTGetMarketsParams | null | undefined, options?: RequestOptions): APIPromise<NFTGetMarketsResponse>;
}
...
export declare namespace NFTGetIDResponse {
    /**
     * NFT collection all time highs
     */
    interface Ath {
     ...
     * NFT collection floor price 14 days percentage change
     */
    interface FloorPrice14dPercentageChange {
        native_currency?: number;
        usd?: number;
    }
    /**
     * NFT collection floor price 1 year percentage change
     */
    interface FloorPrice1yPercentageChange {
        native_currency?: number;
        usd?: number;
    }
    interface FloorPrice24hPercentageChange {
        native_currency?: number;
        usd?: number;
    }
    /**
     * NFT collection floor price 30 days percentage change
     */
    interface FloorPrice30dPercentageChange {
        native_currency?: number;
        usd?: number;
    }
    /**
     * NFT collection floor price 60 days percentage change
     */
    interface FloorPrice60dPercentageChange {
        native_currency?: number;
        usd?: number;
    }
    /**
     * NFT collection floor price 7 days percentage change
     */
    interface FloorPrice7dPercentageChange {
        native_currency?: number;
        usd?: number;
    }
    /**
     ...
     * NFT collection market cap 24 hours percentage change
     */
    interface MarketCap24hPercentageChange {
        native_currency?: number;
        usd?: number;
    }
    /**
     ...
     * NFT collection volume in 24 hours percentage change
     */
    interface Volume24hPercentageChange {
        native_currency?: number;
        usd?: number;
    }
}
...
export declare namespace NFTGetMarketsResponse {
    interface NFTGetMarketsResponseItem {
        /**
         * NFT collection ID
         */
        id?: string;
    ...
    namespace NFTGetMarketsResponseItem {
        /**
         * NFT collection floor price
         */
        interface FloorPrice {
...
export declare namespace NFTs {
    export { type NFTGetIDResponse as NFTGetIDResponse, type NFTGetListResponse as NFTGetListResponse, type NFTGetMarketsResponse as NFTGetMarketsResponse, type NFTGetListParams as NFTGetListParams, type NFTGetMarketsParams as NFTGetMarketsParams, };
    export { Contract as Contract, type ContractGetContractAddressResponse as ContractGetContractAddressResponse, type ContractGetContractAddressParams as ContractGetContractAddressParams, };
    export { MarketChart as MarketChart, type MarketChartGetResponse as MarketChartGetResponse, type MarketChartGetParams as MarketChartGetParams, };
    export { Tickers as Tickers, type TickerGetResponse as TickerGetResponse };
}
//# sourceMappingURL=nfts.d.mts.map