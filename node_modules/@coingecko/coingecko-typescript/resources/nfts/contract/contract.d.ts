...
import { MarketChart, MarketChartGetParams, MarketChartGetResponse } from "./market-chart.js";
import { APIPromise } from "../../../core/api-promise.js";
import { RequestOptions } from "../../../internal/request-options.js";
export declare class Contract extends APIResource {
     ...
     * ```
     */
    getContractAddress(contractAddress: string, params: ContractGetContractAddressParams, options?: RequestOptions): APIPromise<ContractGetContractAddressResponse>;
}
...
export declare namespace ContractGetContractAddressResponse {
    /**
     * NFT collection all time highs
     */
    interface Ath {
...
export declare namespace Contract {
    export { type ContractGetContractAddressResponse as ContractGetContractAddressResponse, type ContractGetContractAddressParams as ContractGetContractAddressParams, };
